module AvaTax
  class Client
    module Filings 
      ...
      # @return [FilingModel[]]
      def approve_filings(companyId, year, month, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/approve"
        post(path, model)      end
      ...
      # @param model [Object] The approve request you wish to execute.
      # @return [FilingModel[]]
      def approve_filings_country(companyId, year, month, country, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/approve"
        post(path, model)      end
      ...
      # @param model [Object] The approve request you wish to execute.
      # @return [FilingModel[]]
      def approve_filings_country_region(companyId, year, month, country, region, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/#{region}/approve"
        post(path, model)      end
      ...
      def create_return_adjustment(companyId, year, month, country, region, formCode, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/#{region}/#{formCode}/adjust"
        post(path, model)      end
      ...
      def create_return_augmentation(companyId, year, month, country, region, formCode, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/#{region}/#{formCode}/augment"
        post(path, model)      end
      ...
      def create_return_payment(companyId, year, month, country, region, formCode, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/#{region}/#{formCode}/payment"
        post(path, model)      end
      ...
      # @return [ErrorDetail[]]
      def delete_return_adjustment(companyId, id, options={})        path = "/api/v2/companies/#{companyId}/filings/adjust/#{id}"
      ...
      # @return [ErrorDetail[]]
      def delete_return_augmentation(companyId, id)        path = "/api/v2/companies/#{companyId}/filings/augment/#{id}"
        delete(path)      end
      ...
      # @return [ErrorDetail[]]
      def delete_return_payment(companyId, id)        path = "/api/v2/companies/#{companyId}/filings/payment/#{id}"
        delete(path)      end
      ...
      # @return [Object]
      def filings_checkup_report(filingsId, companyId)        path = "/api/v2/companies/#{companyId}/filings/#{filingsId}/checkup"
        get(path)      end
      ...
      # @return [Object]
      def filings_checkup_reports(companyId, year, month)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/checkup"
        get(path)      end
      ...
      # @return [Object]
      def get_filing_attachment(companyId, filingReturnId, options={})        path = "/api/v2/companies/#{companyId}/filings/#{filingReturnId}/attachment"
        get(path, options)      end
      ...
      # @return [Object]
      def get_filing_attachments(companyId, year, month)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/attachments"
        get(path)      end
      ...
      # @param month [Integer] The two digit month of the filing period.
      # @return [Object]
      def get_filing_attachments_trace_file(companyId, year, month)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/attachments/tracefile"
        get(path)      end
      ...
      # @return [Object]
      def get_filing_return(companyId, id, options={})        path = "/api/v2/companies/#{companyId}/filings/returns/#{id}"
        get(path, options)      end
      ...
      # @param month [Integer] The two digit month of the filing period.
      # @return [Object]
      def get_filings(companyId, year, month)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}"
        get(path)      end
      ...
      # @param country [String] The two-character ISO-3166 code for the country.
      # @return [Object]
      def get_filings_by_country(companyId, year, month, country)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}"
        get(path)      end
      ...
      # @param region [String] The two or three character region code for the region.
      # @return [Object]
      def get_filings_by_country_region(companyId, year, month, country, region)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/#{region}"
        get(path)      end
      ...
      # @return [Object]
      def get_filings_by_return_name(companyId, year, month, country, region, formCode)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/#{region}/#{formCode}"
        get(path)      end
      ...
      # @param taxformCode [String] The unique tax form code of the form.
      # @return [Object]
      def get_filings_returns(companyId, options={})        path = "/api/v2/companies/#{companyId}/filings/returns"
        get(path, options)      end
      ...
      # @param formCode [String] The unique code of the form.
      # @return [Object]
      def get_tax_filings(companyId, options={})        path = "/api/v2/companies/#{companyId}/filings"
        get(path, options)      end
      ...
      # @return [Object]
      def rebuild_filings(companyId, year, month, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/rebuild"
        post(path, model)      end
      ...
      # @param model [Object] The rebuild request you wish to execute.
      # @return [Object]
      def rebuild_filings_by_country(companyId, year, month, country, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/rebuild"
        post(path, model)      end
      ...
      # @param model [Object] The rebuild request you wish to execute.
      # @return [Object]
      def rebuild_filings_by_country_region(companyId, year, month, country, region, model)        path = "/api/v2/companies/#{companyId}/filings/#{year}/#{month}/#{country}/#{region}/rebuild"
        post(path, model)      end
      ...
      # @return [Object]
      def update_return_adjustment(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filings/adjust/#{id}"
        put(path, model)      end
      ...
      # @return [Object]
      def update_return_augmentation(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filings/augment/#{id}"
        put(path, model)      end
      ...
      # @return [Object]
      def update_return_payment(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filings/payment/#{id}"
        put(path, model)      end
    end
  end
end