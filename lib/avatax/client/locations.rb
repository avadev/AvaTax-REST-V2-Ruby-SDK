module AvaTax
  class Client
    module Locations 
      ...
      # @param companyId [Integer] The ID of the company that owns this location
      # @param id [Integer] The primary key of this location
      # @param model [Object] The new remittance to change the existing location's to, as well as new effective and end date.
      # @return [Object]
      def update_location_remittance(companyId, id, model)        path = "/api/v2/companies/#{companyId}/locations/#{id}/remittance"
        put(path, model)      end
