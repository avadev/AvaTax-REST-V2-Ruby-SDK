module AvaTax
  class Client
    module FilingCalendars 
      ...
      def active_power_of_attorney(companyId, options={})        path = "/api/v2/companies/#{companyId}/filingcalendars/powerofattorney"
      ...
      # @return [Object]
      def approve_filing_request(companyId, id)        path = "/api/v2/companies/#{companyId}/filingrequests/#{id}/approve"
        post(path)      end
      ...
      # @param id [Integer] The unique ID of the filing request object
      # @return [Object]
      def cancel_filing_request(companyId, id)        path = "/api/v2/companies/#{companyId}/filingrequests/#{id}/cancel"
        post(path)      end
      ...
      # @return [Object]
      def cancel_filing_requests(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{id}/cancel/request"
        post(path, model)      end
      ...
      def create_filing_calendars(companyId, model)        path = "/api/v2/companies/#{companyId}/filingcalendars"
        post(path, model)      end
      ...
      def create_filing_requests(companyId, model)        path = "/api/v2/companies/#{companyId}/filingcalendars/add/request"
        post(path, model)      end
      ...
      def create_update_company_return_settings(companyId, filingCalendarId, model)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{filingCalendarId}/settings"
        post(path, model)      end
      ...
      def cycle_safe_add(companyId, options={})        path = "/api/v2/companies/#{companyId}/filingcalendars/add/options"
        get(path, options)      end
      ...
      # @return [Object]
      def cycle_safe_edit(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{id}/edit/options"
        post(path, model)      end
      ...
      # @param id [Integer] The unique ID of the filing calendar object
      # @return [Object]
      def cycle_safe_expiration(companyId, id)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{id}/cancel/options"
        get(path)      end
      ...
      # @return [ErrorDetail[]]
      def delete_filing_calendar(companyId, id)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{id}"
        delete(path)      end
      ...
      # @return [Object]
      def get_filing_calendar(companyId, id)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{id}"
        get(path)      end
      ...
      # @param id [Integer] The primary key of this filing calendar
      # @return [Object]
      def get_filing_request(companyId, id)        path = "/api/v2/companies/#{companyId}/filingrequests/#{id}"
        get(path)      end
      ...
      # @return [FetchResult]
      def list_filing_calendars(companyId, options={})        path = "/api/v2/companies/#{companyId}/filingcalendars"
        get(path, options)      end
      ...
      # @param orderBy [String] A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
      # @return [FetchResult]
      def list_filing_requests(companyId, options={})        path = "/api/v2/companies/#{companyId}/filingrequests"
        get(path, options)      end
      ...
      # @return [Object]
      def login_verification_request(model)        path = "/api/v2/filingcalendars/credentials/verify"
        post(path, model)      end
      ...
      # @return [Object]
      def login_verification_status(jobId)        path = "/api/v2/filingcalendars/credentials/#{jobId}"
        get(path)      end
      ...
      # @return [FetchResult]
      def query_filing_calendars(options={})        path = "/api/v2/filingcalendars"
        get(path, options)      end
      ...
      # @return [FetchResult]
      def query_filing_calendars_post(model, options={})        path = "/api/v2/filingcalendars/query"
      ...
      # @param orderBy [String] A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
      # @return [FetchResult]
      def query_filing_requests(options={})        path = "/api/v2/filingrequests"
        get(path, options)      end
      ...
      # @param model [Object] Query object to filter, sort and paginate the filing calendars.
      # @return [FetchResult]
      def query_filing_requests_post(model, options={})        path = "/api/v2/filingrequests/query"
        post(path, model, options)      end
      ...
      # @return [Object]
      def request_filing_calendar_update(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{id}/edit/request"
        post(path, model)      end
      ...
      # @return [Object]
      def update_filing_calendar(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filingcalendars/#{id}"
        put(path, model)      end
      ...
      # @return [Object]
      def update_filing_request(companyId, id, model)        path = "/api/v2/companies/#{companyId}/filingrequests/#{id}"
        put(path, model)      end
    end
  end
end